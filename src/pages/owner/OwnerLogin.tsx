    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl">Login Owner</CardTitle>
          <p className="text-gray-600">Masuk ke dashboard owner OrderIn</p>
        </CardHeader>
        <CardContent>
          ...
          <div className="mt-6 p-4 bg-purple-50 rounded-md">
            ...
            <p className="text-xs text-purple-700">Username: owner</p>
